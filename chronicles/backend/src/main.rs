...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/api/campaigns/:id/combat", routing::get(api::get_combat_state))
        .route("/api/campaigns/:id/combat/initiative", routing::post(api::submit_initiative))
        .route("/api/campaigns/:id/combat/target", routing::post(api::set_combat_target))
        .route("/api/campaigns/:id/combat/attack", routing::post(api::resolve_attack))
        .route("/api/campaigns/:id/combat/damage", routing::post(api::resolve_damage))
        .route("/api/campaigns/:id/combat/ability", routing::post(api::use_combat_ability))
        .route("/api/campaigns/:id/combat/end-turn", routing::post(api::end_combat_turn))
        .route("/api/campaigns/:id/combat/flee", routing::post(api::flee_combat))
        .route("/api/campaigns/:id/combat/end", routing::post(api::end_combat_handler))
